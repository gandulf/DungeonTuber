...
class LightsWidget(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        #self.lights_list.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.color_edit.setDisabled(True)
        self.color_edit.colorChanged.connect(self.color_changed)
    ...
    def on_lights_found(self, lights: list[Light]):
        ...
        if len(lights) == 0:
            ...
            self.brightness_slider.setDisabled(False)
    ...
    def blockSignals(self, b, /):
        ...
        for widget in [self.light_toggle,self.scenable_edit, self.brightness_slider,self.temperature_slider,self.color_edit,self.scene_combo]:
